...
async function getSites(email){
    return await $.ajax({
        url: "/api/method/mysaas.mysaas.doctype.saas_users.saas_users.get_sites",
        type: "GET",
        dataType: "json",
        data:{
            "email":email
...
async function checkUserNameAndPasswordForAsite(site_name,email,password){
    return wait = await $.ajax({
        url: "/api/method/mysaas.mysaas.doctype.saas_users.saas_users.check_user_name_and_password_for_a_site",
        type: "GET",
