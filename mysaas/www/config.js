const config = {
  ...
  HTTP_METHODS: {
    CHECK_SUBDOMAIN: {
      ENDPOINT:
        "/api/method/mysaas.mysaas.doctype.saas_sites.saas_sites.check_subdomain",
      METHOD: "GET",
      SUCCESS_MESSAGE: "success",
    },
    CHECK_PASSWORD_STRENGTH: {
      ENDPOINT:
        "/api/method/mysaas.mysaas.doctype.saas_sites.saas_sites.check_password_strength",
      METHOD: "GET",
      DATA: {
        PASSWORD: "password",
    ...
    CHECK_SITE_CREATED: {
      ENDPOINT:
        "mysaas.mysaas.doctype.saas_sites.saas_sites.checkSiteCreated",
      SUCCESS_MESSAGE: "yes",
    },
    SEND_OTP: {
      ENDPOINT:
        "/api/method/mysaas.mysaas.doctype.saas_users.saas_users.send_otp",
      METHOD: "GET",
      DATA: {
        PHONE: "phone",
        EMAIl: "email",
    ...
    VERIFY_OTP: {
      ENDPOINT:
        "/api/method/mysaas.mysaas.doctype.saas_users.saas_users.verify_account_request",
      METHOD: "GET",
      DATA: {
        UNIQUE_ID: "unique_id",
        OTP: "otp",
    ...
    CREATE_SITE: {
      ENDPOINT: "mysaas.mysaas.doctype.saas_sites.saas_sites.setupSite",
    },
  },
};
