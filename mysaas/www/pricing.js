class StripeManager {
  ...
  async upgrade(price_id) {
    ...
    await fetch(
      "/api/method/mysaas.mysaas.utils.upgradeOneHashPlan?price_id=" +
        price_id,
      {
        method: "GET",
        headers: {
  ...
  async purcahse(price_id) {
    const { message } = await fetch(
      "/api/method/mysaas.mysaas.utils.createNewPurchaseSession?price_id=" +
        price_id,
      {
        method: "GET",
        headers: {
...
window.onload = async function () {
  ...
  const { message } = await fetch(
    "/api/method/mysaas.mysaas.utils.hasRoleToManageOnehashPayments",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
  ...
  const getUsage = async () => {
    const { message } = await fetch(
      "/api/method/mysaas.mysaas.utils.getUsage",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
