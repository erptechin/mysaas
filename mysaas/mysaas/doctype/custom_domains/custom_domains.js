...
frappe.ui.form.on("Custom domains", {
  refresh: async function (frm) {
    ...
    const http_url = `${window.location.protocol}//${window.location.host}/api/method/mysaas.mysaas.utils.verify_custom_domain`;
    ...
    $(frm.fields_dict.verify.wrapper).on("click", function () {
      ...
      frappe.call({
        ...
        method: "mysaas.mysaas.utils.verify_custom_domain",
        freeze: true,
