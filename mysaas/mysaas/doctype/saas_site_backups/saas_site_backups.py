...
def generateOneHashBackups():
    ...
    for site in sites:
        frappe.enqueue("mysaas.mysaas.doctype.saas_site_backups.saas_site_backups.backup_to_s3_helper",is_manual=1,backup_limit=config.backup_limit,site=site["site_name"],now=1)
