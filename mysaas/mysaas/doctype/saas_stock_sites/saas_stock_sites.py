...
def refreshStockSites(*args, **kwargs):
    ...
    if len(currentStock) < int(config.stock_site_count):
        ...
        for _ in range(number_of_sites_to_stock):
            ...
            this_command.append(
                "bench --site {} execute mysaas.mysaas.doctype.saas_stock_sites.saas_stock_sites.insertSite --args \"'{}','{}'\"".format(
            ...
            method = "mysaas.mysaas.doctype.saas_stock_sites.saas_stock_sites.create_multiple_sites_in_parallel"
